"""
Testa se o valor do saldo inicial da MSC atual é igual ao valor do saldo final da MSC anterior.
...
class Test:
    def __init__(self, app):
        self.name = 'msc_atual_anterior_saldos'
        self.app = app
    ...
    def run(self):
        ...
        resultado = self.compara_atual_anterior(msc_anterior, msc_atual)
    ...
    def compara_atual_anterior(self, msc_anterior, msc_atual):
        resultado = []
        ...
        with tqdm(total=total) as progressbar:
            for i, atual in msc1.iterrows():
                chave = atual['Chave']
                anterior = msc0[msc0['Chave'] == chave]
